      ...
      child: Column(
        ...
        children: [
          Icon(
            ...
            size: 80,
            color: const Color(0xFFB794F4).withOpacity(0.5),
          ),
          ...
          ElevatedButton(
            onPressed: _sendTestNotification,
            style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFB794F4)),
            child: const Text('Send Test Notification', style: TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
